      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="sales.php" class="small-box-footer">info<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a href="products.php" class="small-box-footer">info<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="users.php" class="small-box-footer">info<i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
...
$(function(){
  ...
  var barChartData = {
    ...
    datasets: [
      {
        label               : 'Vendas',
        fillColor           : 'rgba(65,137,48,0.9)',
        strokeColor         : 'rgba(65,137,48,0.8)',
        pointColor          : '#418930',
        pointStrokeColor    : 'rgba(65,137,48,1)',
        pointHighlightFill  : '#fff',
        pointHighlightStroke: 'rgba(65,137,48,1)',
        data                : <?php echo $sales; ?>
      }
    ]
  }
