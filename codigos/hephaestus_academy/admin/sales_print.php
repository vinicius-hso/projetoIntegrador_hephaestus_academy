<?php
	...
	function generateRow($from, $to, $conn){
		...
		foreach($stmt as $row){
			...
			<tr>
				...
				<td>'.$row['pay_id'].'</td>
				<td align="right">R&#36; '.number_format($amount, 2).'</td>
			</tr>
			';
		}
	...
	if(isset($_POST['print'])){
	    ...
	    $content = '';  
	    $content .= '
	      	<h2 align="center">Hephaestus</h2>
	      	<h4 align="center">RELATÓRIO DE VENDAS</h4>
	      	<h4 align="center">'.$from_title." - ".$to_title.'</h4>
	      	<table border="1" cellspacing="0" cellpadding="3">  
	           <tr>  
	           		<th width="15%" align="center"><b>Data</b></th>
	                <th width="30%" align="center"><b>Nome comprador</b></th>
					<th width="40%" align="center"><b>Transação#</b></th>
					<th width="15%" align="center"><b>Valor</b></th>  
	           </tr>  
	      ';  
		...
		$_SESSION['error'] = 'Necessário período para imprimir relatório de vendas';
